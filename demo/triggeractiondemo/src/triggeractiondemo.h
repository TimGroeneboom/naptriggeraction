...
namespace nap 
{
    ...
    private:
		...
		ObjectPtr<UDPClient>        mUDPClient = nullptr;           ///< Pointer to the UDP Client
        ObjectPtr<ParameterGUI>     mParameterGUI = nullptr;        ///< Pointer to the ParameterGUI
        ObjectPtr<SequenceEditorGUI> mSequenceEditorGUI = nullptr;
